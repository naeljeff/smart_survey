...
var GoSurveyExteriorCameraBtn = function (_a) {
    ...
    return (react_1["default"].createElement(react_native_1.TouchableOpacity, { onPress: onPress, className: "shadow-2xl drop-shadow-xl" },
        react_1["default"].createElement(react_native_1.View, { className: "rounded-lg bg-[#faa72c] px-1.5 py-1" },
            react_1["default"].createElement(EvilIcons_1["default"], { name: 'camera', size: 24, color: 'white' }))));
};
