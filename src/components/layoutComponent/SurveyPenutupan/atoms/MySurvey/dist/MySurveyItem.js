...
var MySurveyItem = react_1["default"].memo(function (_a) {
    ...
    return (react_1["default"].createElement(react_native_1.View, { className: "w-screen py-0.5 px-1 border-b border-black" },
        react_1["default"].createElement(react_native_1.TouchableOpacity, { onPress: handleListPress, className: "w-screen flex flex-row justify-start items-center" },
            ...
            react_1["default"].createElement(react_native_1.View, { className: "flex-[0.15] flex-col gap-y-1" },
            ...
            react_1["default"].createElement(react_native_1.View, { className: "flex-[0.2] flex-col justify-center items-center pr-1.5 -ml-2" },
                react_1["default"].createElement(react_native_1.Text, { className: "text-[11px] text-black uppercase mb-2" }, item.status)))));
});
