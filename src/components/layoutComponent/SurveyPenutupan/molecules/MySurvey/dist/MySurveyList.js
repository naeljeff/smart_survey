...
var MySurveyItem_1 = require("../../atoms/MySurvey/MySurveyItem");
var MySurveyList = function (_a) {
    ...
    var renderItem = react_1.useCallback(function (_a) {
        ...
        return (react_1["default"].createElement(MySurveyItem_1["default"], { item: item, index: index, navigation: navigation }));
    }, [navigation]);
