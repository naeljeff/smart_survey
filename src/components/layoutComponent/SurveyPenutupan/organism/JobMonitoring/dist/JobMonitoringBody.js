...
var JobMonitoringUserList_1 = require("../../molecules/JobMonitoring/JobMonitoringUserList");
var navigationHelper_1 = require("../../../../../utilities/navigationHelper");
var storeUser_1 = require("../../../../../store/storeUser");
var JobMonitoringBody = function () {
    ...
    var _e = getNewSurveyData_1.UseGetNewSurveyData(fullName), data = _e.data, isLoading = _e.isLoading, isError = _e.isError, refetch = _e.refetch, error = _e.error;
    ...
    return (react_1["default"].createElement(react_native_1.View, { className: "flex-1 flex flex-col" },
        react_1["default"].createElement(SurveyPenutupanSearchInput_1["default"], { setSearchTerm: setSearchTerm, searchTab: "JobMonitoring", setSearchByTerm: setSearchByTerm, setSortBy: setSortBy, setOrderBy: setOrderBy }),
        ...
        isLoading ? (react_1["default"].createElement(react_native_1.View, { className: "w-full flex-1 bg-[#f7ebd7] inset-0 justify-center items-center" },
            react_1["default"].createElement(react_native_1.ActivityIndicator, { size: "large", color: "#f5af46" }))) : (react_1["default"].createElement(JobMonitoringUserList_1["default"], { data: data, search: searchTerm, searchByTerm: searchByTerm, sortBy: sortBy, orderBy: orderBy, refreshing: isLoading, onRefresh: refetch, navigation: navigation }))));
};
exports["default"] = JobMonitoringBody;
