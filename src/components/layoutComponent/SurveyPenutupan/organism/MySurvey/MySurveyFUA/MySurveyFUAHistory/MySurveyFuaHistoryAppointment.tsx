...
type MySurveyFuaHistoryAppointmentProps = {
  item: surveyJobProps;
};

const MySurveyFuaHistoryAppointment = ({
  item,
}: MySurveyFuaHistoryAppointmentProps) => {
  return (
...
export default MySurveyFuaHistoryAppointment;
