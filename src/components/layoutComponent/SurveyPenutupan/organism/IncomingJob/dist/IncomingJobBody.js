...
var IncomingJobBody = function () {
    ...
    return (react_1["default"].createElement(react_native_1.View, { className: "flex-1 flex flex-col" },
        react_1["default"].createElement(SurveyPenutupanSearchInput_1["default"], { setSearchTerm: setSearchTerm, searchTab: "IncomingJob", setSearchByTerm: setSearchByTerm, setSortBy: setSortBy, setOrderBy: setOrderBy }),
        ...
        isLoading ? (react_1["default"].createElement(react_native_1.View, { className: "w-full flex-1 bg-[#f7ebd7] inset-0 justify-center items-center" },
            react_1["default"].createElement(react_native_1.ActivityIndicator, { size: "large", color: "#f5af46" }))) : (react_1["default"].createElement(IncomingJobList_1["default"], { data: data, search: searchTerm, searchByTerm: searchByTerm, sortBy: sortBy, orderBy: orderBy, refreshing: isLoading, onRefresh: refetch, navigation: navigation }))));
};
exports["default"] = IncomingJobBody;
