...
exports.useUserLoginWithEmailAndGenerateJwt = void 0;
...
exports.useUserLoginWithEmailAndGenerateJwt = function (email, password, deviceId) {
    var queryKey = ['userValidationEmail', email, password];
    var _a = react_query_1.useQuery({
        ...
        queryFn: function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getUserValidationWithEmail(email, password)];
                    case 1:
